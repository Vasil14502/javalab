...
public class MainGenerics {
    public static void main(String[] args) {
        ...
        studentRepo.getAll().forEach(student -> System.out.printf("%s %s, ID: %s, Enrollment: %s%n",
                student.firstName(), student.lastName(), student.studentId(), student.enrollmentDate()));
        ...
        profRepo.getAll().forEach(p -> System.out.printf("%s %s, Department: %s%n", p.firstName(), p.lastName(), p.department()));
        ...
        courseRepo.getAll().forEach(c -> System.out.printf("%s, Credits: %d, Semester: %d%n", c.getTitle(), c.getCredits(), c.getSemester()));
